...
\newcommand\FooterCompanyDetails{%
  \begin{tikzpicture}[remember picture,overlay]
    \node[yshift=5cm,xshift=1cm,anchor=south west,inner sep=3pt](payment-due-bg) at (current page.south west)
      {\small \sffamily \textsc{$lang.payment-due-text$}};
    \fill[mpx-lightgrey] ([yshift=5cm]current page.south west) [rounded corners=0.1cm] -- 
      ([xshift=-0.1cm]payment-due-bg.south west) [rounded corners=0.1cm] -- 
      (payment-due-bg.north west) [rounded corners=0.1cm] -- 
      (payment-due-bg.north east) [rounded corners=0.1cm] -- 
      ([xshift=0.1cm]payment-due-bg.south east) -- 
    ...
    \draw[mpx-grey] ([yshift=5cm]current page.south west) [rounded corners=0.1cm] -- 
      ...
      ([xshift=0.1cm]payment-due-bg.south east) --
      ([yshift=5cm]current page.south east);
    \node[yshift=5cm,xshift=1cm,anchor=south west,inner sep=3pt](payment-due) at (current page.south west)
      {\small \sffamily \textsc{$lang.payment-due-text$}};
    \matrix[
      %draw,nodes=draw,
      yshift=4cm,
...
\CurrencySetup{kind=symbol, mode=text, font=\fontspec{montserrat}}
...
\begin{spreadtab}{{tabular}[t t t t t]{lp{6cm}p{1.5cm}p{1.5cm}r}}
  \hdashline[1pt/1pt]
  % header
  ...
  @ \multicolumn{4}{r}{\textbf{$lang.total-text$:}}
