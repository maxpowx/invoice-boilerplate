...
\begin{spreadtab}{{tabular}[t t t]{lp{8.2cm}r}}
  \hdashline[1pt/1pt]
  % header
  @ \noalign{\vskip 2mm} \textbf{$lang.invoice-line-text$} & @ \textbf{$lang.description-column-text$} & @ \textbf{$lang.unit-price-column-text$} \\ \hline
  % invoice lines
  ...
  $if(from.vat-rate)$
    @ & @ \multicolumn{1}{r}{$lang.subtotal-text$:}                & \dCurrency{$invoice.currency$}{:={sum(c1:[0,-1])}} \\ \hhline{~~-}
    @ & @ \multicolumn{1}{r}{$lang.vat-text$ $from.vat-rate$\%:}   & \dCurrency{$invoice.currency$}{:={$from.vat-rate$/100*[0,-1]}} \\ \hhline{~~-}
  $endif$
  % total
  @ & @ \multicolumn{1}{r}{\textbf{$lang.total-text$:}}   & \dCurrency{$invoice.currency$}{:={$if(from.vat-rate)$[0,-1]+[0,-2]$else$sum(c1:[0,-1])$endif$}} \\ \hhline{~~-}
\end{spreadtab}
