...
\newcommand\FooterCompanyDetails{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \matrix[
      ...
      column 1/.style={text width=4mm, align=center},
      column 2/.style={text width=3.2cm, align=left},
      column 3/.style={text width=7.5cm, align=center},
      column 4/.style={text width=4mm, align=center},
      column 5/.style={text width=3.2cm, align=left},
      ampersand replacement=\&
     ](companyinfo) at (current page.south)
     {
      \node{};                     \& \node{};                                            \& \node{$from.name$}; \\
      \node{};                     \& \node{};                                            \& \node{$from.vat$}; \\[4mm,between borders]
      \node{\faBuilding[regular]}; \& \node{$from.address.line-one$};                     \& \node{$from.bank.name$};  \& \node{\faMobile*}; \& \node{\href{tel:$from.phone$}{$from.phone$}}; \\
      \node{};                     \& \node{$from.address.zip-code$ $from.address.city$}; \& \node{$from.bank.bic$};   \& \node{\faAt};      \& \node{\href{mailto:$from.online.e-mail$}{$from.online.e-mail$}}; \\
      \node{};                     \& \node{$from.address.country$};                      \& \node{$from.bank.iban$};  \& \node{\faFirefox}; \& \node{\href{$from.online.website$}{$from.online.website$}}; \\
     };
...
\usepackage{atbegshi}
\pagestyle{empty}
\AtBeginShipout{\HeaderSimple\FooterSimple}
