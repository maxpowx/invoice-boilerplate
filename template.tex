...
\begin{spreadtab}{{tabular}[t t t]{lp{8.2cm}r}}
  \hdashline[1pt/1pt]
  % header
  @ \noalign{\vskip 2mm} \textbf{$lang.invoice-line-text$} & @ \textbf{$lang.descriptioncolumn-text$} & @ \textbf{$lang.pricecolumn-text$} \\ \hline
  % invoice lines
      $for(service)$ @ \noalign{\vskip 2mm} \refstepcounter{pos} \thepos 
        ...
        $if(service.details)$\newline \begin{itemize} 
          ...
          $endfor$ \end{itemize}
        $endif$%
        & \dCurrency{$invoice.currency$}{:={$service.price$}}\\
      $endfor$%
