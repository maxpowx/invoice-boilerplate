...
\newcommand\FooterSimple{%
  \begin{tikzpicture}[remember picture,overlay]
    \fill[light-fooder-bg] ([yshift=0.5cm]current page.south west) -- ([yshift=0.5cm]current page.south east) --
      ...
      \shade[top color=light-fooder-edge!100, middle color=light-fooder-edge!100, bottom color=light-fooder-bg!100] % end color of the gradient(current page.south west) -- (current page.south east) --
            (current page.south west) -- (current page.south east) --
            ([yshift=0.5cm]current page.south east) -- ([yshift=0.5cm]current page.south west) -- cycle;
  ...
  % invoice lines
      $for(service)$
        ...
        $if(show-metadata)$
          $if(service.metadata)$%
            \begin{blockquote} 
              \scriptsize \color{light-text-accent1}
