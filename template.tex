...
\newcommand\FooterCompanyDetails{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \matrix[
     ...
     {
      \node{\textcolor{mpx-blue}{\textbf{$from.name$}} \textcolor{mpx-brown}{$from.legalform$}}; \\
      \node{$from.vat$}; \\
     };
     \matrix[
      %draw,nodes=draw,
...
% currency package issuein applying font: https://github.com/antoinelejay/currency/issues/9
\CurrencySetup{kind=symbol, font=\fontspec{montserrat}}
